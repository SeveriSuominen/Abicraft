...
namespace AbicraftNodeEditor {
    ...
    public static class NodeEditorReflection {
        ...
        public static Type[] GetNodeTypes() {
            ...
            return GetDerivedTypes(typeof(AbicraftNode));
        }
        ...
        public static bool TryGetAttributeTint(this Type nodeType, out Color tint) {
            if (nodeTint == null) {
                CacheAttributes<Color, AbicraftNode.NodeTintAttribute>(ref nodeTint, x => x.color);
            }
        ...
        public static bool TryGetAttributeWidth(this Type nodeType, out int width) {
            if (nodeWidth == null) {
                CacheAttributes<int, AbicraftNode.NodeWidthAttribute>(ref nodeWidth, x => x.width);
            }
        ...
        public static FieldInfo GetFieldInfo(this Type type, string fieldName) {
            ...
            while (field == null && (type = type.BaseType) != typeof(AbicraftNode)) field = type.GetField(fieldName, BindingFlags.NonPublic | BindingFlags.Instance);
            return field;
        }
