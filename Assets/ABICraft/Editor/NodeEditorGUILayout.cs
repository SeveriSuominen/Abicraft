...
namespace AbicraftNodeEditor {
    ...
    public static class NodeEditorGUILayout {
        ...
        static Color fieldbg = Color.grey, hold;
        ...
        public static void PropertyField(SerializedProperty property, GUIContent label, NodePort port, bool includeChildren = true, params GUILayoutOption[] options) {
            ...
            else
            {
                ...
                if (port.direction == NodePort.IO.Input)
                {
                    ...
                    AbicraftNode.InputAttribute inputAttribute;
                    ...
                    bool usePropertyAttributes = dynamicPortList ||
                        showBacking == AbicraftNode.ShowBackingValue.Never ||
                        (showBacking == AbicraftNode.ShowBackingValue.Unconnected && port.IsConnected);
                    ...
                    if (dynamicPortList)
                    {
                        ...
                        AbicraftNode.ConnectionType connectionType = inputAttribute != null ? inputAttribute.connectionType : AbicraftNode.ConnectionType.Multiple;
                ...
                else if (port.direction == NodePort.IO.Output)
                {
                    ...
                    {
                        Type type = GetType(property);
                        AbicraftNode.ConnectionType connectionType = outputAttribute != null ? outputAttribute.connectionType : AbicraftNode.ConnectionType.Multiple;
                        DynamicPortList(property.name, type, property.serializedObject, port.direction, connectionType);
                        return;
                    }
                    switch (showBacking)
