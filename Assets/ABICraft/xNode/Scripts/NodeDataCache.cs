...
namespace AbicraftNodeEditor {
    ...
    public static class NodeDataCache {
        ...
        public static void UpdatePorts(AbicraftNode node, Dictionary<string, NodePort> ports) {
        ...
        private static void BuildCache() {
            ...
            System.Type baseType = typeof(AbicraftNode);
        ...
        public static List<FieldInfo> GetNodeFields(System.Type nodeType) {
            ...
            while ((tempType = tempType.BaseType) != typeof(AbicraftNode)) {
        ...
        private static void CachePorts(System.Type nodeType) {
            ...
            for (int i = 0; i < fieldInfo.Count; i++) {
                ...
                AbicraftNode.InputAttribute inputAttrib = attribs.FirstOrDefault(x => x is AbicraftNode.InputAttribute) as AbicraftNode.InputAttribute;
                AbicraftNode.OutputAttribute outputAttrib = attribs.FirstOrDefault(x => x is AbicraftNode.OutputAttribute) as AbicraftNode.OutputAttribute;
