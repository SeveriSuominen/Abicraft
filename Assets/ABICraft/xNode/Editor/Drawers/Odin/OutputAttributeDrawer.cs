...
namespace XNodeEditor {
	public class OutputAttributeDrawer : OdinAttributeDrawer<AbicraftNode.OutputAttribute> {
		...
		protected override void DrawPropertyLayout(GUIContent label) {
			...
			if (!NodeEditor.inNodeEditor) {
				if (Attribute.backingValue == AbicraftNode.ShowBackingValue.Always || Attribute.backingValue == AbicraftNode.ShowBackingValue.Unconnected && !port.IsConnected)
